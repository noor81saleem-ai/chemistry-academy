    ...
    <div className="container-wide py-8">
      ...
      <div className="page-heading-box mt-6 mb-8">
        ...
        <p className="mt-3 max-w-3xl text-ink-muted leading-relaxed">
          Comprehensive MDCAT Chemistry preparation covering Physical,
          Inorganic and Organic Chemistry. Each section includes topic-wise
          study notes, key concepts, MCQs and practice questions.
        </p>
        ...
        {mdcatGroups.map((group, i) => {
          ...
          return (
            ...
            >
              ...
              <h2 className="mt-3 font-serif text-xl font-semibold text-ink group-hover:text-brand-700 transition-colors">
                {group.title}
              </h2>
