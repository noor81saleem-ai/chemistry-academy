...
export default function LongQuestionPage({ params }: { params: { slug: string; number: string } }) {
  ...
  return (
    <div className="container-narrow py-8">
      <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'FSc', href: '/fsc' }, { label: 'Grade 12', href: '/fsc/grade-12' }, { label: content.title, href: '/fsc/grade-12/' + params.slug }, { label: 'Long Question ' + params.number }]} />
      <div className="mt-6">
        <TopicReader backHref={'/fsc/grade-12/' + params.slug} backLabel={'Back to ' + content.title} title={question.question} subtitle={'Long Question ' + params.number + ' · ' + content.title}>
